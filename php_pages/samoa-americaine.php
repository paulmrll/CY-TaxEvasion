        ...
        <form method="post" action="../php/register_travel.php">
            ...
            <div class="reservation-slider-container">
                ...
                <div class="reservation-checkbox">
                    <h5>Repas :</h5>
                    <div>
                        <input type="radio" id="repas1" name="repas" value="Spa et Jacuzzi Prive" required>
                        <label class="reservation-button" for="repas1">Matin</label>

                        <input type="radio" id="repas2" name="repas" value="Spa et Jacuzzi Prive">
                        <label class="reservation-button" for="repas2">Soir</label>

                        <input type="radio" id="repas3" name="repas" value="Diner gastronomique 5 etoiles">
