                                    ...
                                    <div class="grid-line-container">
                                        <div>
                                            ...
                                            <input type="text" name="name" value="<?php echo $_SESSION['name']; ?>"
                                                   required>
                                            <img class="modif-image" src="../image/visibility-logo.png"
                                            ...
                                            <div class="grid-container">
                                                <div class="line-container">
                                                    ...
                                                    <div class="date-container">
                                                        <p>Du :
                                                            <strong><?php echo $content[$a]['travels'][$i]['departure'] ?></strong>
                                                        </p>
                                                        <p>Au :
                                                            <strong><?php echo $content[$a]['travels'][$i]['return'] ?></strong>
                                                        </p>
                                                    </div>
