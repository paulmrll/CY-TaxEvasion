...
function user_modification($email, $firstname, $name, $number, $rue, $ville, $cdp, $birth, $todo, $role)
{
...
if (isset($_POST['email']) && isset($_POST['firstname']) && isset($_POST['name']) && isset($_POST['nb']) && isset($_POST['rue']) && isset($_POST['ville']) && isset($_POST['cdp']) && isset($_POST['birth']) && isset($_POST['todo']) && isset($_POST['role'])) {
    ...
    $todo = $_POST['todo'];
    $role = $_POST['role'];
    user_modification($email, $firstname, $name, $nb_rue, $rue, $ville, $cdp, $birth, $todo, $role);
